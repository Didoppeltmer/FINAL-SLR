...
OUTPUT_UNFORMATTED = './GPToutput_unformatted.csv'
...
def validate_gpt_response(initial_response, original_text):
    """Validiert die erste Antwort von GPT mit einer zweiten KI-Anfrage"""
...
def process_text_file(filename):
    ...
    if initial_result:
        time.sleep(30)
        validated_result = validate_gpt_response(initial_result, text)
